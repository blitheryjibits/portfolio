    ...
    <header className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-6 py-3 bg-[#14091f]/80 backdrop-blur-md border-b border-[#bc13fe]/20">
      ...
      <nav className=" w-full">
        <div className="h-100% flex-1">
          ...
          {/* menu list */}
          <ul
            className={`absolute top-0 -right-full w-1/3 md:w-full h-fit
              flex flex-col gap-4
              bg-background/80 backdrop-blur-sm 
              peer-checked:right-0
              transtition-all duration-300
              md:max-w-fit md:flex md:flex-row md:right-0 md:top-4 md:h-full
              md:gap-8 md:pt-0 md:pr-4 md:text-sm md:bg-transparent md:backdrop-blur-none
